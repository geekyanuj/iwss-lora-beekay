...
const ToastItem: React.FC<{ toast: Toast; onClose: () => void }> = ({ toast, onClose }) => {
  ...
  const getStyles = () => {
    const baseStyles = 'mb-3 p-4 rounded-lg shadow-lg flex items-center gap-3 transition-all duration-300 transform';
    
    if (isExiting) {
      return `${baseStyles} opacity-0 translate-x-96 scale-95`;
    }
